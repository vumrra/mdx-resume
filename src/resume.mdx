...
## 복잡한 도메인을 단순하게 풀기 위해 노력하며, <br /> 오너십을 가지고 끊임없이 문제를 정의하고 해결합니다.

<div class="content">

본교 입학 지원 시스템과 전국 서비스형 플랫폼 등 복잡한 비즈니스를 다뤄온 프로젝트 경험을 통해,  
요구사항을 명확히 정의하고 단순한 구조로 구현해 내는 데 강점을 가지고 있습니다.

기술을 넘어 팀과 서비스의 방향을 고민하며, 목표를 명확히 이해하고 필요한 일을 스스로 찾아 실행합니다.  
오너십을 바탕으로 문제를 정의하고 해결하며, 팀과 함께 지속적으로 성장하는 것을 추구합니다.

솔루션 선택에 있어 문제를 다각도로 분석하며, 어떤 상황에 가장 효과를 낼 수 있을지 고민하고 판단합니다.  
피드백은 성장의 중요한 발판이라 생각합니다. 부족한 점에 열린 자세로 피드백을 수용하며 스스로를 개선해 나갑니다.
...
배팅 정산 처리 로직은 Spring Batch를 사용해 개발되었습니다.  
...
힉생들은 공고를 놓치기 쉽고, 선생님들은 이력서 수합과 지원자 관리에 어려움을 겪고 있었습니다.  
이러한 문제를 해결하기 위해, 채용 공고 및 지원자 관리 웹 서비스를 기획하고,  
7일 만에 MVP를 개발해 교내에 즉시 상용화했습니다.  
