import HG_INFRA from "/public/hg-infra.png";
...
<label class="modal-trigger small-img">
  ...
  <img src="/public/hg-infra.png" alt="aws-infra-img" class="thumbnail-img" />
...
<label class="modal-trigger img">
  <input type="checkbox" class="modal-toggle" hidden />
  <img src="/public/gogo-ddd.png" alt="gogo-ddd-img" class="thumbnail-img img" />
